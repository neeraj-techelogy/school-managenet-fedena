...
ActiveRecord::Schema.define(:version => 20191001074037) do
  ...
  add_index "cce_reports", ["observable_id", "student_id", "batch_id", "exam_id", "observable_type"], :name => "cce_report_join_index", :limit => {"student_id"=>nil, "observable_id"=>nil, "exam_id"=>nil, "observable_type"=>nil, "batch_id"=>nil}
